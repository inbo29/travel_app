                    ...
                    {loading ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 animate-fade-in-up">
                            {filteredItems.map(item => (
                                <div key={item.id} className={`${glassClasses} p-6 rounded-[2rem] bg-white/60 dark:bg-white/5 border border-white/20 dark:border-white/5 flex items-center justify-between hover:scale-[1.02] transition-all`}>
                                    <div>
